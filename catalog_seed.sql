...
class ProductCatalogSeeder extends Seeder
{
    ...
    {
        // 1. Truncate table to avoid duplicate rows
        ...
        $products = [
            // ==========================================
            // 1. KOKUM & AGAL RANGE (Flagship Goan Line)
            // ==========================================
            [
                'category' => 'Kokum & Agal',
                'name' => 'Kokum Squash',
            ...
            [
                ...
                'description' => 'Refreshing raw green mango (Kairi) cooler with cumin and cooling spices.',
            ...
            [
                ...
                'description' => '100% pure Indian Gooseberry (Amla) juice with zero added sugar. Boosts natural immunity.',
            ...
            [
                'category' => 'Squashes & Juices',
                'name' => 'Jamun Juice',
                'description' => 'Pure Black Plum (Jamun) juice, highly recommended for healthy blood sugar management.',
            ...
            [
                ...
                'description' => 'Royal dessert syrup infused with saffron strands and aromatic green cardamom.',
            ...
            [
                ...
                'description' => 'Classic aromatic pink rose syrup. Perfect for milkshakes, lassi, and falooda.',
            ...
            [
                ...
                'description' => 'Authentic tangy-sweet Kala Khatta fruit syrup for golas, soda mocktails, and slushes.',
            ...
            [
                ...
                'description' => 'Refreshing Betel Leaf (Paan) crush with natural gulkand and digestive spices.',
            ...
            [
                ...
                'description' => 'Real strawberry crush packed with whole fruit pieces for smoothies and milkshakes.',
            ...
            [
                'category' => 'Syrups & Crushes',
                'name' => 'Kiwi Crush',
                'description' => 'Tangy kiwi pulp with natural seeds for gourmet beverages and bakery.',
            ...
            [
                ...
                'description' => 'Traditional saffron and mawa flavor crush for milkshakes and traditional desserts.',
            ...
            [
                'category' => 'Syrups & Crushes',
                'name' => 'Zeera Cordial',
                'description' => 'Digestive cumin and lemon drink concentrate for post-meal refreshment.',
            ...
            [
                ...
                'description' => 'Traditional Goan digestive pachak made with lime, ginger, amla, cumin, and black pepper. Enhances appetite and relieves acidity.',
            ...
            [
                ...
                'description' => 'Almonds, cashews, pistachios, walnuts, dates, and figs immersed in pure natural forest honey.',
            ...
            [
                ...
                'name' => 'Tomato Ketchup',
                'description' => 'Rich and thick tomato ketchup made with ripe red tomatoes and spices.',
            ...
            [
                ...
                'description' => 'Spicy and tangy green pepper sauce for Chinese and Indian cuisine.',
        ...
        // 2. Insert products & their variants
